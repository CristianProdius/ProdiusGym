    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                .transition(.opacity)
                .animation(.easeOut(duration: 0.15), value: currentStep)

                Spacer()
            }

            // Bottom gradient layer (sits behind buttons, above content)
            BottomGradient()
                .zIndex(1)
...
// MARK: - Bottom Gradient (extracted for performance)
